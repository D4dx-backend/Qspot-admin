...
const YouTubeThumbnail = ({ url, className, alt = "YouTube thumbnail" }) => {
                ...
                <>
                  {currentVideos.map((video) => (
                    <div key={video._id} className="bg-gray-900 rounded-lg shadow-md overflow-hidden border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:shadow-lg">
                      <div className="flex">
                        {/* Video Preview */}
                        <div className="w-48 h-32 flex-shrink-0 relative pt-2 pl-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-gray-400 mt-1">Enter a direct link to a video file (MP4, WebM, etc.) or YouTube URL</p>
            </div>
